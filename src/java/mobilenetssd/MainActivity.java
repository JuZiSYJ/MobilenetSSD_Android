...
public class MainActivity extends Activity
{
    ...
    private MobilenetSSD squeezencnn = new MobilenetSSD();
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        buttonDetect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                {
                    infoResult.setText(result+" time: " +time+" ms");
...
//        byte[] words = null;
        ...
        {
            InputStream assetsInputStream = getAssets().open("mobilenetssd.param.bin");
        ...
        {
            InputStream assetsInputStream = getAssets().open("mobilenetssd.bin");
            int available = assetsInputStream.available();
